#ifndef Dialog_Image_Sepia_hpp
#define Dialog_Image_Sepia_hpp
...
public:
	...
	Dialog_Image_Sepia(std::vector < Layer* > layers) : Dialog(L"sepia", sf::Vector2f(256,160), sf::Vector2f(8, 120)) {
