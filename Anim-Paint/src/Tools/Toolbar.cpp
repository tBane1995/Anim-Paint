...
Toolbar::Toolbar() : ElementGUI() {
	...
	// clipboard
	_clipboard_text = new sf::Text(basicFont, L"clipboard", 13);
	...
	// tools
	_tools_text = new sf::Text(basicFont, L"tools", 13);
	...
	_sizes_text = new sf::Text(basicFont, L"size", 13);
	...
	_first_color_text_col = new sf::Text(basicFont, L"color", 13);
	_first_color_text_val = new sf::Text(basicFont, L"1", 13);
	_second_color_text_col = new sf::Text(basicFont, L"color", 13);
	_second_color_text_val = new sf::Text(basicFont, L"2", 13);
	...
	// colors
	_colors_text = new sf::Text(basicFont, L"colors", 13);
	...
	for (auto& c : _colors) {
		c->_onclick_func = [this, c]() {
			_selectedColorButton->setColor(c->_rect.getFillColor());
			};
	}
...
Toolbar::~Toolbar() {
	...
	delete _clipboard_text;
	delete _tools_text;
	delete _sizes_text;
	delete _first_color_text_col;
	delete _first_color_text_val;
	delete _second_color_text_col;
	delete _second_color_text_val;
	delete _colors_text;
}
