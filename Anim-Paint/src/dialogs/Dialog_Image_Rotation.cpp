...
Dialog_Image_Rotation::Dialog_Image_Rotation(std::vector < Layer* > layers) : Dialog(L"rotation", sf::Vector2f(256, 160), sf::Vector2f(8, 120)) {
...
Dialog_Image_Rotation::~Dialog_Image_Rotation() {
...
void Dialog_Image_Rotation::setPosition(sf::Vector2f position) {
...
void Dialog_Image_Rotation::setTheFilter() {
...
void Dialog_Image_Rotation::cursorHover() {
	Dialog::cursorHover();
...
void Dialog_Image_Rotation::handleEvent(sf::Event& event) {
...
void Dialog_Image_Rotation::update() {
	Dialog::update();
...
void Dialog_Image_Rotation::draw() {
	Dialog::draw();
