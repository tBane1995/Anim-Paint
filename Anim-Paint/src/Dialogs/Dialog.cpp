...
Dialog::Dialog(std::wstring title, sf::Vector2i size, sf::Vector2i position, bool absolutePositioning) : Element() {
	...
	_closeBtn = std::make_shared<ButtonWithSprite>(getTexture(L"tex\\btn32\\close.png"), getTexture(L"tex\\btn32\\close_hover.png"), getTexture(L"tex\\btn32\\close_press.png"));
