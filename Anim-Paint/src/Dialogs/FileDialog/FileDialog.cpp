...
FileDialog::FileDialog(std::wstring dialogName, std::wstring selectButtonText, std::wstring acceptableExtention) : Dialog(dialogName, sf::Vector2i(400, 284), sf::Vector2i(8, 120), true) {
	...
	_selectBtn->setRectColors(dark_button_select_color, dark_button_idle_color, dark_button_hover_color, dark_button_press_color, dark_button_inactive_color);
	_selectBtn->_onclick_func = [this](){
		_state = DialogState::ToClose;
		};

	_cancelBtn = std::make_shared<ColoredButtonWithText>(L"Cancel", btnSize);
	_cancelBtn->setRectColors(dark_button_select_color, dark_button_idle_color, dark_button_hover_color, dark_button_press_color, dark_button_inactive_color);
