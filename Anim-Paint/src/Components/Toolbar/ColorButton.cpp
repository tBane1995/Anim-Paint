...
ColorButton::ColorButton(sf::Color color) : ButtonWithSprite(getTexture(L"tex\\tools\\frame.png"), getTexture(L"tex\\tools\\frame_hover.png"), getTexture(L"tex\\tools\\frame_hover.png")) {
	_color = color;
